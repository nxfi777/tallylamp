# Tallylamp documentation

If this is your first deployment, start with the [project README](../README.md).
It walks through hosting Tallylamp, connecting an agent, and trying a browser handoff.
...
| Change the code and clean up a local run | [Contributor guide](contributing.md) |

[Research notes](research.md) record the sources and decisions behind the design.
