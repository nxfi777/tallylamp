...
The template sets up the public `0.8.3` image, a persistent `/data` volume,
...
docker run --rm --platform linux/amd64 -p 127.0.0.1:8080:8080 \
  ...
  -v tallylamp-data:/data \
   ghcr.io/nxfi777/tallylamp:0.8.3
```
...
dedicated Xvfb display, ffmpeg, and xdotool. The published `0.8.3` image
